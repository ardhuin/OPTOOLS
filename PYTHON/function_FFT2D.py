...
def FFT2D_one_array(arraya,nxa,nya,dx,dy,n,isplot=0):
...
# Etb is PSD of 2st image (arraya) 
	...
	kx2,ky2 = np.meshgrid(kxs,kys, indexing='xy')
	if isplot:
...
def FFT3D_one_array(arraya,nxa,nya,nt,dx,dy,dt,n,isplot=0):
# function to do a FFT 2D 
# nxa, nya : size of arraya
# dx,dy : resolution of arraya
# n : number of tiles in x and y directions 
# 
# Eta is PSD of 1st image (arraya) 
	mspec=n**2+(n-1)**2
