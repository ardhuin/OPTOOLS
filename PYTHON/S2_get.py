...
for isun in range(0,nz1*nz2):
   ...
   iy=int((suncell[1]-uly)/5000)
   sung[ix,iy,0]=suncell[2]
   sung[ix,iy,1]=suncell[3]
   sung[ix,iy,2]=suncell[4][0]
   sung[ix,iy,3]=suncell[4][1]
   sung[ix,iy,4]=suncell[4][2]
