...
# Modified by F. Ardhuin on April, 1, 2022: adding sun angles in the output of get_angleobs
...
def get_angleobs(XML_File):
    ...
    AngleSun = { 'zone' : zone, 'hemis' : hemis, 'nrows' : nrows, 'ncols' : ncols, 'ul_x' : ulx, 'ul_y' : uly, 'sun' : [] }
